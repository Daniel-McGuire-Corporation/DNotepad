...
;Settings
  ...
  !define APPNAME "DNotepad"
  !define APP_NAME_IN_INSTALLED_DIR "DNotepad"
  !define COMPANYNAME "Daniel McGuire Corporation"
  !define DESCRIPTION "Simple Notepad"
  !define DEVELOPER "Daniel McGuire" #License Holder
  # Files Directory
  !define FILE_DIR "..\..\src\bin\Release\net6.0-windows7.0" #Replace with the path of install folder (Should be right unless file structure tampered.)
  ...
  !define VERSIONMAJOR 0	#Major release Number
  !define VERSIONMINOR 1	#Minor release Number
  !define VERSIONBUILD 17	#Maintenance release Number (bugfixes only)
  !define BUILDNUMBER 27	#Source control revision number
  # These will be displayed by the "Click here for support information" link in "Add/Remove Programs"
  # It is possible to use "mailto:" links in here to open email client
  !define HELPURL "https://github.com/Daniel-McGuire-Corporation/DNotepad/issues/"
  !define UPDATEURL "https://github.com/Daniel-McGuire-Corporation/DNotepad/releases/latest"
  !define ABOUTURL "https://github.com/Daniel-McGuire-Corporation/DNotepad"
...
;General
  ...
  Name "${APPNAME}"
  Icon "${LOGO_ICON_FILE}"
  OutFile "DNotepadSetup.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES\DNotepad"
